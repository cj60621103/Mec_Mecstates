<?php
class Mec_Mecstates_Block_Adminhtml_Customer_Edit_Tab_Addresses extends Mage_Adminhtml_Block_Customer_Edit_Tab_Addresses{
	public function __construct()
    {
        parent::__construct();
        $this->setTemplate('mecstates/customer/tab/addresses.phtml');
    }
	...
	public function initForm()
    {
		...
		// $regionElement->addClass('regionId');
        if ($regionElement) {
	...
	public function getCitysUrl()
    {
        return $this->getUrl('*/json/regionCity');
    }
